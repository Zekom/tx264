...
function SetProgressState(hwnd: THandle;
  const AState: TTaskBarProgressState): boolean;
...
type
  ...
  ITaskBarList3 = interface(IUnknown)
    ...
    procedure MarkFullscreenWindow(hwnd: THandle;
      fFullscreen: boolean); stdcall;
    procedure SetProgressValue(hwnd: THandle; ullCompleted: UInt64;
    ...
    procedure SetTabActive(hwndTab: THandle; hwndMDI: THandle;
      tbatFlags: Cardinal); stdcall;
    procedure ThumbBarAddButtons(hwnd: THandle; cButtons: Cardinal;
      pButtons: PThumbButton); stdcall;
    procedure ThumbBarUpdateButtons(hwnd: THandle; cButtons: Cardinal;
      pButtons: PThumbButton); stdcall;
    procedure ThumbBarSetImageList(hwnd: THandle; himl: THandle); stdcall;
    procedure SetOverlayIcon(hwnd: THandle; hIcon: THandle;
      pszDescription: PChar); stdcall;
    procedure SetThumbnailTooltip(hwnd: THandle;
      pszDescription: PChar); stdcall;
